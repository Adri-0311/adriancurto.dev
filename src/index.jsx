...
export default ({ devTech, comp, jobs }) => (
  <>
    <div className='mb-8'>
      ...
      /> */}
      <p>
        Soy <b>desarrollador web</b>. Desde que descubrí el mundo de la web
        considero que es el futuro, solo hay que ver como las grandes empresas
        migran sus aplicaciones de escritorio a aplicaciones como servicio (
        <b>SaaS</b>) en la web.
      </p>
      <p>
        Actualmente me gustaría dar un giro en mi carrera profesional y poder
        trabajar con las siguientes tecnogías:
      </p>
